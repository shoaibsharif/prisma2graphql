...
import { Rule, RuleAnd, RuleOr, RuleNot, RuleTrue, RuleFalse, InputRule, RuleChain } from './rules';
/**
 *
 * @param name
 * @param options
 ...
 * @param schema
 */
export declare const inputRule: <T>(name: string | ((yup: typeof Yup) => Yup.Schema<T>), schema?: (yup: typeof Yup) => Yup.Schema<T>) => InputRule<T>;
/**
 *
 * @param rules
 *
