...
class Photon {
    constructor(options = {}) {
        ...
        this.engine = new runtime_1.Engine({
            ...
            datasources,
            generator: { "name": "photon", "provider": "photonjs", "output": "/Volumes/HardDisk/Practice/JavaScript/prisma2tests/node_modules/@generated/photon", "platforms": [], "pinnedPlatform": null, "config": {} },
            platform: undefined
        });
